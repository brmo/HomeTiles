...
static const lcd_init_cmd_t kTab5St7123Init[] = {
    ...
    {0xA3, (uint8_t[]){
               0x80, 0x01, 0x88, 0x30, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,
     ...
     39, 0},
    {0xA6, (uint8_t[]){
               0x03, 0x00, 0x24, 0x55, 0x36, 0x00, 0x39, 0x00, 0x6E, 0x6E,
     ...
     55, 0},
    {0xA7, (uint8_t[]){
               0x19, 0x19, 0x80, 0x64, 0x40, 0x07, 0x16, 0x40, 0x00, 0x44,
     ...
     60, 0},
    {0xAC, (uint8_t[]){
               0x03, 0x19, 0x19, 0x18, 0x18, 0x06, 0x13, 0x13, 0x11, 0x11,
     ...
     44, 0},
    {0xAD, (uint8_t[]){
               0xF0, 0x00, 0x46, 0x00, 0x03, 0x50, 0x50, 0xFF, 0xFF, 0xF0,
               0x40, 0x06, 0x01, 0x07, 0x42, 0x42, 0xFF, 0xFF, 0x01, 0x00,
               0x00, 0xFF, 0xFF, 0xFF, 0xFF},
     25, 0},
    {0xAE, (uint8_t[]){0xFE, 0x3F, 0x3F, 0xFE, 0x3F, 0x3F, 0x00}, 7, 0},
    {0xB2, (uint8_t[]){
               0x15, 0x19, 0x05, 0x23, 0x49, 0xAF, 0x03, 0x2E, 0x5C, 0xD2,
               0xFF, 0x10, 0x20, 0xFD, 0x20, 0xC0, 0x00},
     17, 0},
    {0xE8, (uint8_t[]){
               0x20, 0x6F, 0x04, 0x97, 0x97, 0x3E, 0x04, 0xDC, 0xDC, 0x3E,
               0x06, 0xFA, 0x26, 0x3E},
     14, 0},
    {0x75, (uint8_t[]){0x03, 0x04}, 2, 0},
    {0xE7, (uint8_t[]){
               0x3B, 0x00, 0x00, 0x7C, 0xA1, 0x8C, 0x20, 0x1A, 0xF0, 0xB1,
    ...
    // These tail commands made the panel unstable (full-screen flicker / noisy lines)
    // on the raw Arduino_GFX DSI path. Keep them disabled for now and build back
    ...
    // {0xC8, (uint8_t[]){
    //            0x00, 0x00, 0x10, 0x1F, 0x36, 0x00, 0x5D, 0x04, 0x9D, 0x05,
    ...
    //  37, 0},
    {0x11, nullptr, 0, 120},
    // Hangs immediately after SLPOUT on direct DSI init.
    // Isolate TE enable separately.
    // {0x35, (uint8_t[]){0x00}, 1, 0},
    {0x29, nullptr, 0, 20},
};

inline constexpr Tab5DisplayConfig kTab5DisplayConfig{
    2,    // hsync_pulse_width
    40,   // hsync_back_porch
    40,   // hsync_front_porch
    2,    // vsync_pulse_width
    8,    // vsync_back_porch
    220,  // vsync_front_porch
    80000000,
    960,
    720,
    1280,
    ...
    false,
    kTab5St7123Init,
    sizeof(kTab5St7123Init) / sizeof(lcd_init_cmd_t),
};
