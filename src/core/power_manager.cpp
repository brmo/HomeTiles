...
static constexpr uint32_t kImuWakePollMs = 40;
static constexpr float kImuWakeDelta = 0.12f;
static constexpr float kImuWakeMagDelta = 0.06f;
static constexpr float kImuWakeMagJerk = 0.05f;
