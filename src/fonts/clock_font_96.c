 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --bpp 4 --no-compress --no-prefilter --no-kerning --format lvgl --lv-include lvgl.h --size 96 --font C:\Users\seb_w\AppData\Local\Microsoft\Windows\Fonts\Montserrat-Medium.ttf -r 0x20,0x2E-0x3A,0x41,0x4D,0x50 --lv-font-name clock_font_96 -o src/fonts/clock_font_96.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 98, .adv_w = 541, .box_w = 41, .box_h = 90, .ofs_x = -3, .ofs_y = -10},
    {.bitmap_index = 1943, .adv_w = 1025, .box_w = 56, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 3875, .adv_w = 568, .box_w = 26, .box_h = 67, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4746, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 6480, .adv_w = 879, .box_w = 51, .box_h = 68, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 8214, .adv_w = 1028, .box_w = 61, .box_h = 67, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 10258, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 11992, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 13821, .adv_w = 919, .box_w = 52, .box_h = 67, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 15563, .adv_w = 989, .box_w = 54, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 17426, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 19255, .adv_w = 349, .box_w = 14, .box_h = 52, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 19619, .adv_w = 1124, .box_w = 72, .box_h = 67, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 22031, .adv_w = 1467, .box_w = 72, .box_h = 67, .ofs_x = 10, .ofs_y = 0},
    {.bitmap_index = 24443, .adv_w = 1109, .box_w = 55, .box_h = 67, .ofs_x = 10, .ofs_y = 0}
};
